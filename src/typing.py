# Python Typing Stubs Module
# This code is taken from a pull request of the MicroPython library and will be in the library at some point.
# Pull Request
#     https://github.com/micropython/micropython-lib/pull/584
# File: typing.py
#     https://github.com/micropython/micropython-lib/blob/5e939e6876b2c6e0d1ace6628f93ce0c6f1a08a5/python-stdlib/typing/typing.py
